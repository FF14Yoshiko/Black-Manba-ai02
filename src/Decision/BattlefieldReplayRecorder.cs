    ...
    private object BuildObjectiveFrame(BattlefieldSnapshot snapshot)
        => new
        {
            ...
            mapTactics = new
            {
                ...
                snapshot.MapTactics.DangerSummaryText,
                snapshot.MapTactics.TerrainAdvantageSummaryText,
                snapshot.MapTactics.PassabilitySummaryText,
                snapshot.MapTactics.RewardModelSummaryText,
                snapshot.MapTactics.MapKnowledgeFocusText,
